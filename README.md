...
| **Авто и водители** | **Советы + погода** |
| ![Авто](docs/screenshots/05-fleet.png) | ![Советы](docs/screenshots/06-tips.png) |

> Живой пример советника: пресет «Омск → Исилькуль» находит 1 034 ДТП в коридоре ±400 м,
> самые спокойные часы выезда — 04:00–05:00 (×0.14 к среднему), самые опасные —
> 18:00–19:00 (×1.74).
